...
PainelComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: PainelComponent, selectors: [["app-painel"]], decls: 21, vars: 2, consts: [[1, "container"], [1, "jumbotron"], [1, "row"], [1, "col-sm-6"], [1, "d-flex", "justify-content-end"], [1, "col"], [1, "form-group"], ["rows", "3", 1, "form-control", 3, "input"], ["type", "button", 1, "btn", "btn-primary", 3, "click"]], template: function PainelComponent_Template(rf, ctx) { if (rf & 1) {
...
ProgressoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ProgressoComponent, selectors: [["app-progresso"]], decls: 2, vars: 0, consts: [[1, "progress"], [1, "progress-bar", "w-50"]], template: function ProgressoComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
...
TentativasComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TentativasComponent, selectors: [["app-tentativas"]], decls: 3, vars: 3, consts: [[3, "src"]], template: function TentativasComponent_Template(rf, ctx) { if (rf & 1) {
